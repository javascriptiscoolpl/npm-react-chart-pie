...
var ChartPie = function (_React$Component) {
  ...
  function ChartPie(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChartPie).call(this, props));
  ...
  _createClass(ChartPie, [{
    ...
    value: function componentDidMount() {
      ...
      this.state.chr = new Chart(ctx, { type: 'pie', data: ChartData, options: GlobalOptions });
    }
  }, {
...
module.exports = { ChartPie: ChartPie };
